...
const AdminDashboard = () => {
  ...
  /* ------------------------------------------------------------------------ */
  /*  Initialization (auth check & data fetching)                           */
  /* ------------------------------------------------------------------------ */
  useEffect(() => {
  ...
  const fetchUserLocations = async () => {
    try {
      ...
      setUserLocations(enriched as UserLocation[]);
    } catch (error: any) {
      toast({
  ...
  const fetchPanicAlerts = async () => {
    try {
      ...
      setPanicAlerts(enriched as PanicAlert[]);
      setLoading(false);
    } catch (error: any) {
      toast({
                          ...
                          <CardContent className="p-6">
                            <div className="flex items-start justify-between">
                              ...
                              <div className="flex flex-col gap-2 ml-4">
                                ...
                                <Badge
                                  variant={
                                    user.nationality ? "default" : "secondary"
                                  }
                                >
