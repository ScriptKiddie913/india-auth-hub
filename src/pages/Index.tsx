    ...
    <div className="min-h-screen relative">
      ...
      <div className="container mx-auto px-4 py-12 md:py-20 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 mt-12 md:mt-20">
          ...
          <Card className="text-center hover:shadow-xl transition-all duration-300 transform hover:scale-105 border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <div className="mx-auto w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-accent to-primary rounded-full flex items-center justify-center mb-3 md:mb-4">
                <Star className="w-6 h-6 md:w-8 md:h-8 text-white" />
              </div>
              <CardTitle className="text-lg md:text-2xl font-bold">1000+ Experiences</CardTitle>
              <CardDescription className="text-sm md:text-lg">
          ...
          <Card className="text-center hover:shadow-xl transition-all duration-300 transform hover:scale-105 border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardTitle className="text-lg md:text-2xl font-bold">50M+ Travelers</CardTitle>
              <CardDescription className="text-sm md:text-lg">
